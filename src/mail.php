	...
	?>
			...
			<script>
				Swal.fire({
					...
					icon: 'error',
					text: 'Authentication error, contact an administrator',
					showClass: {
						popup: 'animate__animated animate__fadeInDown'
					},
					hideClass: {
